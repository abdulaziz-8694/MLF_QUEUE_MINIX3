...
int do_noquantum(message *m_ptr)
{
	...
	{
		//printf("User Process. Quantum consumed.\n");
		if(rmp->num_quantum){
			rmp->num_quantum++;
		}
		else
			rmp->num_quantum=1;
		if(rmp->num_quantum==5){
			printf("Process %d consumed quantum 5 and its priority %d\n",rmp->endpoint,rmp->priority);
			rmp->priority=USER_Q;
		}
		else if(rmp->num_quantum==10){
			printf("Process %d consumed quantum 10 and its priority %d\n",rmp->endpoint,rmp->priority);
			rmp->priority=MIN_USER_Q;
		}
		else if(rmp->num_quantum>=20)
		{
			printf("Process %d consumed quantum 20 and its priority %d\n",rmp->endpoint,rmp->priority);
			rmp->num_quantum=0;
